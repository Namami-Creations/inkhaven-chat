const FAQ = [
  ...
  {
    q: 'Is voice/video required?',
    a: 'No. You can keep it text-only, or use voice/video when both sides agree. All features are optional.'
  },
  {
  ...
  },
  {
    ...
    a: 'Basic features are free. Premium unlocks unlimited chats, priority matching, and HD video calls.'
  },
  {
